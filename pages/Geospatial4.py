# -*- coding: utf-8 -*-
"""
Created on Sat May 18 23:32:14 2024
...
# DATASET
try:
    df = pd.read_excel("New Model 4_Clusters.xlsx")
...
layout = html.Div(children=[
    ...
    dcc.Graph(id="map_chart4")
])

# CALLBACKS
@callback(
    Output('map_chart4', 'figure'),
